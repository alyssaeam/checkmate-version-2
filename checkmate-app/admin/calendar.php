...
if (!isAdmin()) { header("Location: ../shared/login.php"); exit(); }
...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
    ...
    <div class="d-flex gap-2 flex-wrap">
        <a href="<?php echo adminCalUrl($month, $year, $selected_date, !$show_completed); ?>"
        ...
        <a href="<?php echo adminCalUrl((int)date('n'), (int)date('Y'), $today, $show_completed); ?>"
           class="cm-btn cm-btn-ghost">
...
<div class="row g-4">
    ...
    <div class="col-lg-7">
        <div class="cm-card">
            <!-- Navigation: uses .cal-nav so prev/next + dropdowns align correctly -->
            <div style="padding:14px 16px;border-bottom:1px solid var(--border)">
                <div class="cal-nav">
                    ...
                    <a href="<?php echo adminCalUrl(
                       ...
                       class="cm-icon-btn flex-shrink-0" title="Previous month">
                    ...
                    <a href="<?php echo adminCalUrl(
                            ...
                            $selected_date, $show_completed); ?>"
                       class="cm-icon-btn flex-shrink-0" title="Next month">
            ...
            <div style="padding:14px 16px">
                <div class="cal-grid">
                    ...
                    ?>
                    <a href="<?php echo adminCalUrl($month,$year,$ds,$show_completed); ?>"
                       class="<?php echo $cls; ?>">
                ...
                <div class="cal-legend">
                    ...
                    <span class="cal-legend-item">
                        <span class="cal-dot" style="position:static;font-size:9px">3</span>
                        Tasks due
                    </span>
                </div>
            </div>
            ...
            <div class="cm-card-header">
                <div>
                    ...
                    <div class="cm-card-subtitle">
                        ...
                        &nbsp;&mdash;&nbsp;
                        <?php echo $show_completed ? 'all tasks' : 'pending only'; ?>
                    </div>
                </div>
            </div>
                   ...
                   class="cm-list-item">
                    ...
                    <span class="cm-status-badge cm-status-<?php
                        echo $task['status']==='Completed'?'done'
                            :($task['status']==='For Confirmation'?'confirm':'pending'); ?>">
