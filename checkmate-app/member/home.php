...
<div class="cm-card">
    ...
    <div class="cm-list">
        ...
        ?>
        <a href="task_detail.php?id=<?php echo $task['id']; ?>&from=<?php echo $task['task_type'] === 'own' ? 'private' : 'assigned'; ?>"
           class="cm-list-item">
            <div class="cm-list-item-body">
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <span class="cm-cat-dot"
                          style="background:<?php echo htmlspecialchars($task['cat_color']); ?>"></span>
                    <?php endif; ?>
                ...
                <div class="cm-list-item-meta">
                    ...
                    <?php if (strtotime($task['due_datetime']) < time() && $sv < 3): ?>
                    <span style="color:var(--danger);margin-left:6px">Overdue</span>
                    <?php endif; ?>
                </div>
            </div>
